...
$GLOBALS['ACTIVE_FAVICON'] = 'no'; /* 'yes' active shaarli favicon recuperation */
$GLOBALS['DATE_FORMAT'] = '\l\e d/m/Y \à H\h i\m s\s'; /* active date format */
$GLOBALS['SHAARLO_URL'] = 'http://domaine.ext/shaarlo/'; /* your shaarlo's url (usefulfor the main RSS) */
